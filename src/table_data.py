...
table_data: Dict[Tables, TableInfo] = {
    ...
    Tables.NDT_BEST_SERVERS: {
        "create_query": ndt_best_servers_create_query,
        "insert_query": ndt_best_server_insert_query,
        "post_insert_query": None,
        "csv_name": CsvFiles.NDT_BEST_SERVERS.value,
        "cleaning_fn": None,
    },
    Tables.CF_BEST_SERVERS: {
        "create_query": cf_best_servers_create_query,
        "insert_query": cf_best_server_insert_query,
        "post_insert_query": None,
        "csv_name": CsvFiles.CF_BEST_SERVERS.value,
